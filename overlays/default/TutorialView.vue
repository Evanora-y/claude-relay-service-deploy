  ...
  <div class="card p-3 sm:p-6">
    ...
    <div v-if="activeTutorialSystem === 'windows'" class="tutorial-content">
      <div class="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
        <h6 class="mb-2 font-medium text-green-800 dark:text-green-300">自动化安装</h6>
        <p class="mb-3 text-sm text-green-700">
          我们为您准备了快捷的安装工具，如需手动安装请继续阅读文档！
        </p>
        <p class="mt-2 text-sm text-green-700">
          下载Claude Code-Win自动化安装器：<a
            href="https://static-resources-aibaota.creativeai.work/claudelike%E5%AE%89%E8%A3%85%E5%99%A8/win%E7%89%88%E6%9C%AC.rar"
            >点我下载</a
          >
        </p>
      </div>
    ...
    <div v-else-if="activeTutorialSystem === 'macos'" class="tutorial-content">
      <div class="rounded-lg border border-green-200 bg-green-50 p-3 sm:p-4">
        ...
        <p class="mt-2 text-sm text-green-700">
          下载Claude Code-macOs自动化安装器：<a
            href="https://static-resources-aibaota.creativeai.work/claudelike%E5%AE%89%E8%A3%85%E5%99%A8/mac%E7%89%88%E6%9C%AC.zip"
            >点我下载</a
          >
        </p>
      </div>
